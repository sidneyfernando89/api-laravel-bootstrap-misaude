...
//        array(
//            'title' => 'Components',
//            'path'  => '//preview.keenthemes.com/metronic8/demo7/documentation/base/utilities.html',
//        ),
//
//        array(
//            'title' => 'Documentation',
//            'path'  => '//preview.keenthemes.com/metronic8/demo7/documentation/getting-started.html',
//        ),
//    ),
    ...
    'main'          => array(
        ...
        array(
            'title' => 'Dashboard',
            'path'  => '',
            'icon'  => theme()->getSvgIcon("demo7/media/icons/duotune/art/art002.svg", "svg-icon-2"),
        ),

        //// Modules
        array(
            'classes' => array('content' => 'pt-8 pb-2'),
            'content' => '<span class="menu-section text-muted text-uppercase fs-8 ls-1">Modulos</span>',
        ),
        ...
        array(
            'title'      => 'Conta',
            'icon'       => array(
                'svg'  => theme()->getSvgIcon("demo7/media/icons/duotune/communication/com006.svg", "svg-icon-2"),
        ...
        array(
            'title'      => 'Protocolo',
            'icon'       => array(
                'svg'  => theme()->getSvgIcon("demo7/media/icons/duotune/general/gen025.svg", "svg-icon-2"),
        ...
        array(
            ...
            'sub'        => array(
                ...
                'items' => array(
                    ...
                    array(
                        'title' => 'Documentation',
                        'icon'  => theme()->getSvgIcon("demo7/media/icons/duotune/abstract/abs027.svg", "svg-icon-2"),
                        'path'  => 'documentation/getting-started/overview',
                    ),
                    ...
                    array(
                        ...
                        'icon'  => theme()->getSvgIcon("demo7/media/icons/duotune/general/gen005.svg", "svg-icon-2"),
                        'path'  => 'documentation/getting-started/changelog',
                    ),
                ),
            ),
