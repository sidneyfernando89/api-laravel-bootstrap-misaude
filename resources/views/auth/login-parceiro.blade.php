<x-auth-layout>
    ...
    <!--begin::Signin Form-->
    <form method="POST" action="{{ theme()->getPageUrl('login-parceiro') }}" class="form w-100" novalidate="novalidate" id="kt_sign_in_form">
    @csrf
    ...
    <!--begin::Heading-->
        ...
        <div class="mb-10 bg-light-info p-8 rounded"><div class="text-info"> Informe o login <strong>admin@demo.com</strong> e senha <strong>demo</strong> para continuar. </div></div>
        ...
        <div class="fv-row mb-10">
            <label class="form-check form-check-custom form-check-solid">
                ...
                <span class="form-check-label fw-bold text-gray-700 fs-6">{{ __('Lembrar meus dados') }}
            </span>
            </label>
        </div>
        <!--end::Input group-->
